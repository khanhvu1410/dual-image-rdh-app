...
async def embed_data(
    ...
    return await embedding_service.embed_data(image_files, data_file)
...
async def embed_preview(
    ...
    return await embedding_service.embed_preview(image_files, data_file)
...
async def extract_data(
    ...
    return await extracting_service.extract_preview(image_file_1, image_file_2, key_file)
